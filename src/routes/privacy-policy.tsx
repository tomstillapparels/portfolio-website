...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How TOMSTILL PVT LTD collects, uses, and safeguards information shared through wholesale inquiries and catalog requests." },
      { property: "og:title", content: "Privacy Policy — TOMSTILL" },
      { property: "og:description", content: "How TOMSTILL collects, uses, and safeguards wholesale inquiry information." },
    ],
  }),
    ...
    <main className="flex-grow w-full max-w-4xl mx-auto px-4 md:px-8 py-12">
      ...
      <div className="space-y-10">
        <Section title="1. Introduction">
          ...
          distributor based in India. This Privacy Policy explains what information we collect
          when you submit a bulk inquiry, request a quote, or contact us, and how we use and
          protect that information. By using this website and submitting your details, you
        ...
        <Section title="3. How We Use Your Information">
          ...
          arrange production and dispatch, and fulfill orders. We may also use your contact
          details to respond to your questions and share catalog updates you have requested.
          We do not sell, rent, or trade your personal information to third parties.
        </Section>

        <Section title="4. WhatsApp Communication">
          Bulk inquiries and quote requests on this site are routed to our official WhatsApp
          number (+91 90354 29042). Messages you send through WhatsApp are governed by WhatsApp's
          own terms and privacy policy in addition to this policy. Please avoid sharing
          sensitive data such as full payment card numbers over WhatsApp.
        </Section>
        ...
        <Section title="5. Data Sharing">
          ...
          Each party is instructed to handle your data confidentially and only for the purpose
          of fulfilling your order.
        </Section>

        <Section title="6. Data Retention">
          We retain inquiry and order records for as long as necessary to fulfill orders, handle
          warranty or quality matters, and meet applicable accounting requirements. You may
          request deletion of your inquiry details at any time by contacting us.
        </Section>

        <Section title="7. Data Security">
          We take reasonable measures to protect the information you share. However, no method
          of transmission over the internet or WhatsApp is fully secure, and we cannot guarantee
          absolute security.
        </Section>

        <Section title="8. Your Rights">
          You may request access to, correction of, or deletion of the personal information you
          have shared with us. To exercise any of these rights, contact us via WhatsApp at
          +91 90354 29042.
        </Section>
